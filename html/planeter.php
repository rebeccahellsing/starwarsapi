<html>
  <meta charset='UTF-8'>
   <head>
	 <title>Inlämningsuppgif 1 - Star Wars - Undersida planeter</title>
	   ...
	   <!-- Navigation meny --> 
		<div class="menu">
			<ul>
	          ...
	          <li><a href="karaktar.php">KARAKTÄRER</a></li>
	    	  <li><a href="planeter.php" id="thisSection"> PLANETER</a></li> 
	        </ul>
	    </div>
...
<?php
		...
		echo "<h3>Undersida Planeter</h3>";

		//---------------Hämtar API från https://swapi.co ------------------------
		$swFile = file_get_contents("https://swapi.co/api/planets/"); //Hämtar filen från api
